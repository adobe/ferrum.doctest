 ...
 *     map(({md, ...obj}) => obj)),
 *   [
 *     { code: 'Example no 1\nSecond line', line: 6, lang: 'js',
 *       file: 'anon_file', name: 'anon_file #0' },
 ...
 *   readFile(`${jsFile}.sqrl`),
 *   readFile(`${mapFile}.sqrl`)]);
 *
 * assertEquals(sourceCode, sqrl(expectedCode));
 * assertEquals(sourceMap.toJSON(), JSON.parse(sqrl(expectedMap)));
 * ```
 *
 * @function
 * @sourcecode
